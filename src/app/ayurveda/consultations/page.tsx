  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="font-serif text-5xl sm:text-6xl text-emerald-900 mb-4">Ayurvedic Consultations</h1>
      ...
      <div className="mb-12">
        <div className="max-w-4xl mx-auto space-y-8">
          <div>
            <h2 className="font-serif text-3xl text-emerald-900 mb-4">A Holistic Approach to Your Health</h2>
          ...
          <div>
            <h2 className="font-serif text-3xl text-emerald-900 mb-4">What You&#39;ll Receive</h2>
      ...
      <section className="mb-12">
        <h2 className="font-serif text-3xl text-emerald-900 mb-8 text-center">Consultation Options</h2>
        <div className="grid gap-6 md:grid-cols-2">
          <div className="bg-emerald-50 p-8 rounded-lg border border-emerald-100 hover:shadow-md transition-shadow">
            <div className="w-12 h-12 bg-emerald-600 rounded-full flex items-center justify-center mb-4">
              <span className="text-2xl">🕐</span>
            </div>
            <h3 className="font-semibold text-xl text-emerald-900 mb-3">Initial Consultation</h3>
            <p className="text-gray-700 mb-4">
              <strong className="text-emerald-900">90 minutes</strong> - Comprehensive health assessment including:
            </p>
          ...
          <div className="bg-emerald-50 p-8 rounded-lg border border-emerald-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-semibold text-xl text-emerald-900 mb-3">Follow-up Sessions</h3>
            <p className="text-gray-700 mb-4">
              <strong className="text-emerald-900">45 minutes</strong> - Flexible session length based on your needs
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
      ...
      <section className="mb-12">
        <h2 className="font-serif text-3xl text-emerald-900 mb-8 text-center">How We Connect</h2>
        <div className="grid gap-6 md:grid-cols-3 max-w-4xl mx-auto">
          <div className="text-center p-6">
            <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-3xl">🏠</span>
            </div>
            <h3 className="font-semibold text-lg text-emerald-900 mb-2">In Person</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="font-semibold text-lg text-emerald-900 mb-2">Phone Call</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="font-semibold text-lg text-emerald-900 mb-2">Video Call</h3>
